...
handling, file downloads, throttling, versioning inputs, and errors. It cannot
prove real Entra admin consent, `Sites.Selected` grants, tenant boundaries, or
Microsoft's live delta behavior. Those require a final test against a real
